...
command! JCimportsRemoveUnused lua require('jc.jdtls').remove_unused_imports()
command! JCimportsAddMissing lua require('jc.jdtls').add_missing_imports()
command! JCimportsOrganizeNoSort lua require('jc.jdtls').organize_imports_nosort()
command! JCimportsStyle lua require('jc.jdtls').set_import_style()
...
command! JCgenerateClassWizard lua require('jc.class_generator').generate_class_wizard()
...
command! JCrefactorMove lua require('jc.refactor').move()
...
command! JCtestDebug lua require('jc.test').debug()
